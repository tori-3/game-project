...
public:
	...
	HashTable<String, std::function<Block* (void)>> maker{
		...
		{U"BigStrawberrySoldier",[]() {return new BigStrawberrySoldierBlock(); }},
		{U"CookieSoldier",[]() {return new CookieSoldierBlock(); }},
		{U"BigCookieSoldier",[]() {return new BigCookieSoldierBlock(); }},
		...
		{U"BigItigoSlave",[]() {return new BigItigoSlaveBlock(); }},
