...
void Main()
{
	...
	const Array<std::pair<String, Array<String>>> menus
	{
		...
		{ U"ブロック", { U"ケーキの地表",U"ケーキのスポンジ",U"ケーキの右壁",U"ケーキの左壁",U"ケーキの右端",U"ケーキの左端",U"チョコレートの壁",U"雲",U"雲の地表",U"雲左下",U"雲右下",U"雲左上",U"雲右上",U"雲左",U"雲右",U"雲下",U"チョコケーキの床",U"チョコケーキの壁",U"チョコケーキの窓"}},
		{U"特殊ブロック",{U"スライダー",U"横に動くチョコレート",U"縦に動くチョコレート",U"ばね",U"もろい壁",U"ベルトコンベア(→)",U"ベルトコンベア(←)",U"すり抜ける床",U"柱ブロック",U"落石",U"転がる岩",U"チョコレートの壁(リスポーン不可)",U"とげ(上)",U"とげ(下)",U"とげ(左)",U"とげ(右)",}},
		{U"敵",{U"イチゴの兵士",U"巨大イチゴの兵士",U"イチゴタワー",U"クッキーの兵士",U"巨大クッキーの兵士",U"雪だるま",U"イチゴスポナー",U"奴隷イチゴ",U"巨大奴隷イチゴ",U"わたあめ",U"コーン",U"鞭クッキー",U"鞄クッキー",U"零戦クッキー",U"雪だるナイト",U"奴隷商クッキー",U"船長",U"ラスボス"}},
		{U"設定ブロック",{U"プレイヤー"}},
		{U"背景",{U"アイスクリーム",U"キャンドル",U"キャンディー",U"ステック",U"さくらんぼ",U"ブルーベリー",U"窓",U"ドア(背景)"}},
		{U"ギミック",{U"ドア",U"鷹",U"看板",U"妖精",U"フォーチュンクッキー"}},
	};
