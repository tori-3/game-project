...
void Main()
{
	...
	const Array<std::pair<String, Array<String>>> menus
	{
		...
		{U"特殊ブロック",{U"スライダー",U"横に動くチョコレート",U"縦に動くチョコレート",U"ばね",U"もろい壁",U"ベルトコンベア(→)",U"ベルトコンベア(←)",U"すり抜ける床"}},
		{U"敵",{U"イチゴの兵士",U"クッキーの兵士",U"雪だるま",U"イチゴスポナー",U"奴隷イチゴ",U"わたあめ",U"コーン",U"鞭クッキー",U"鞄クッキー",U"零戦クッキー",U"雪だるナイト",U"奴隷商クッキー"}},
		{U"設定ブロック",{U"プレイヤー"}},
